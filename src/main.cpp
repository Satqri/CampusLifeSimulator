...
int main() {
    ...
    if (!fontOk) fontOk = font.openFromFile("C:/Windows/Fonts/msyh.ttc");
    if (!fontOk) fontOk = font.openFromFile("C:/Windows/Fonts/simhei.ttf");
    if (!fontOk) fontOk = font.openFromFile("/System/Library/Fonts/Supplemental/Arial.ttf");

...
struct GameContext {
    ...
    std::function<void(int minutes, const Attributes& delta,
                       ...
                       const std::string& activityId, bool customDuration)> runTimedActivity;
    std::function<void(int minutes, const Attributes& delta, const HiddenMap& hiddenDelta,
                       const std::string& title, const std::string& body,
                       const std::string& activityId, bool customDuration)> runTimedActivityWithHidden;
    std::function<void(const std::string& title, const std::string& body)> showTimedResult;
    std::function<bool(int previousMinute)> checkEventTriggers;

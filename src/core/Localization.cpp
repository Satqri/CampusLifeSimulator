...
const std::unordered_map<std::string, std::pair<std::string, std::string>> kTexts = {
    ...
    {"settlement.primary_ending", {"Primary Ending", "主结局"}},
    {"settlement.also_achieved", {"Also Achieved", "同时达成"}},
    {"settlement.final_stats", {"Final Stats", "最终属性"}},
    {"settlement.no_extra_titles", {"No extra titles earned", "暂无额外称号"}},
